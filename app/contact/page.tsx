            ...
            <motion.div variants={slideLeft.moderate}>
              <Card className="border-l-4 border-l-red shadow-lg h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="font-heading font-bold text-xl sm:text-2xl text-navy mb-4">
            ...
            <motion.div variants={slideRight.moderate}>
              <Card className="border-l-4 border-l-red shadow-lg h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <CardContent className="p-6 sm:p-8">
                  <div className="text-4xl sm:text-5xl mb-6 hover:scale-105 transition-transform">🤝</div>
                  <h3 className="font-heading font-bold text-xl sm:text-2xl text-navy mb-4">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            variants={fadeUp.moderate}
          >
            <h2 className="font-heading font-bold text-3xl sm:text-4xl text-navy text-center mb-8 sm:mb-12">
              What Sets Me Apart
            </h2>
            
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            variants={fadeUp.moderate}
          >
            <h2 className="font-heading font-bold text-3xl sm:text-4xl text-navy text-center mb-4">
              Key Competencies
            </h2>
            <p className="text-lg sm:text-xl text-gray-700 text-center mb-8 sm:mb-12 max-w-3xl mx-auto">
          ...
          <motion.div 
            ...
            viewport={{ once: false, amount: 0.3 }}
          >
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Line Management</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Proven experience managing multi-tiered teams, ensuring wellbeing, welfare, development, and motivation</p>
            </motion.div>
            
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Risk Management</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Expert in identifying, analyzing, and managing risk to inform balanced, evidence-based decisions, incorporating counter-terrorism and dynamic risk assessment principles.</p>
            </motion.div>
            
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Analytical Skills</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Skilled in using specialized software to extract, analyze, plan, and report on operational data</p>
            </motion.div>
            
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Communication</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Adaptable language and messaging to meet diverse stakeholder needs—students, staff, emergency services</p>
            </motion.div>
            
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Resilience</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Professional resilience and wellbeing management for oneself and others in complex situations</p>
            </motion.div>
            
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Flexibility</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Fully flexible and accustomed to 24/7 operations with rotating shift patterns</p>
            </motion.div>
            
            <motion.div variants={fadeUp.light} className="bg-navy text-white p-4 sm:p-6 rounded-lg md:col-span-2">
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-3">✅ Protective Security & Counter-Terrorism</h3>
              <p className="leading-relaxed opacity-90 text-sm sm:text-base">Qualified at Level 6 in Counter Terrorism Awareness and Protective Security. Experienced in integrating prevention, preparedness, and response principles into event and campus operations.</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            variants={fadeUp.moderate}
          >
            <h2 className="font-heading font-bold text-2xl sm:text-3xl md:text-4xl text-navy mb-6">
              Ready to Strengthen Your Security Operations?
            </h2>
